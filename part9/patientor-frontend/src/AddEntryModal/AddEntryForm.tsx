      ...
      validate={(values) => {
        ...
        if (
          ...
          errors = {
            ...errors,
            discharge: {
              date: "Occupational health entry does not support discharge date and/or criteria. Please remove these values.",
            },
          };
        }
        if (
          ...
          errors = {
            ...errors,
            discharge: {
              date: "Healthcheck entry does not support discharge date and/or criteria. Please remove these values.",
            },
          };
        }
        if (
